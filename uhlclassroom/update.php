...
<form style="float:right; margin-top: 25px;" method="post" action="searchs.php?go"  id="searchform"/>
    ...
    <div id="tooplate_menu" class="ddsmoothmenu">
        <ul>
            <li><a href="welcome_admin.php" class="select">Home</a></li>
...
username='$name', email='$email', usertype='$usertype', password='$password',
verify_user='$verify' where id='$id'");
}

$sql = "SELECT * FROM `login` where usertype='Mentor'";
...
echo "<b><a href='update.php?update={$row['id']}'>{$row['username']}</a></b>";echo "<br>";
echo "<b><a href='update.php?update={$row['id']}'>{$row['usertype']}</a></b>";
?>

<p> <a style="color: #ffffff;" class="btn btn-lg btn-info btn-block" href="deluser.php?id=<?php echo $row['id'];?>"> Delete Mentor </a> </p>
<?php
echo "<br /><br />";
echo "</td>";
echo "</tr>";
