...
//$image = addslashes(file_get_contents($_FILES['fileToUpload']['tmp_name']));
    ...
    $sql = "INSERT INTO `mentorform` (user_id, fullname, email, quali, insti, occupation) VALUES ('$userid','$fullname','$email','$quali','$insti','$occupation')";
...
?>
<?php if (!($_SESSION['usertype']== 'Mentor' && $_SESSION['verify_user']== '1' or $_SESSION['usertype']== 'Admin' )){header("location:login.php");
}?>
...
<form class="form-signin" method="POST">
    ...
    <label for="quali" class="sr-only">Qualifications</label>
    <input type="varchar" name="quali" id="inputquali" class="form-control" placeholder="Qualifications" required autofocus>
    <label for="Insti Name" class="sr-only">Institute</label>
    <input type="text" name="institute" id="inputPassword" class="form-control" placeholder="Institute" required>
    <label for="input occupation" class="sr-only">Occupation</label>
    <input type="text" name="occupation" id="inputPassword" class="form-control" placeholder="Occupation" required>
