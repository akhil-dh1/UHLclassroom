...
?>
<?php if (!($_SESSION['usertype']== 'Mentor' && $_SESSION['verify_user']== '1' or $_SESSION['usertype']== 'Admin' )){header("location:login.php?msg= Please log in.");
}?>
...
<br>
<div align="right" style="width: 150px; margin:0px;  ">
<p> <a style="color: #ffffff;" class="btn btn-lg btn-info btn-block" href="delete3.php?user_id=<?php echo $_SESSION['user_id'];?>"> Delete details </a> </p>
  </div>
