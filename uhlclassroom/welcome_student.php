...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()){        
        echo '<dd>'?>
     <img src="<?php echo $row['image'];?>" width="150" height="200" style="margin:-10px" >
     <?php
     '</dd>';
...
<div style="width: 150px; margin:35px; ">
...
?>
<p style="text-align:center;"><a style="color: #00BFFF;" href= "stuform.php"> <img src="images/stuform.png"   width="150"></a></p>
        ...
        <div class="slider-wrapper theme-default">
            <div id="slider" class="nivoSlider">
                ...
                <img src="images/slider/school2.jpg" alt="" title="#caption2" />
                 <img src="images/slider/school3.jpg" alt="" title="#caption1"  />
                <img src="images/slider/school4.jpg" alt="" title="#caption3" />                
            </div>
