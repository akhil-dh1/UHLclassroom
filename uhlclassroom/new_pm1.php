...
<?php
        {
        $rec = mysqli_query($connection,"select login.email from login inner join(pm on login.id= pm.receiver)");
        
        if($rec){


    $Host = "mail.iitmandi.ac.in";                                          // SMTP servers
        $User = "eis@iitmandi.ac.in";       // SMTP password
...
//We display the form
            	...
            	<div class="content">
            		...
            		<form action="new_pm1.php" method="post" enctype="multipart/form-data">
