...
<html>
    <head>
        ...
        function startTimer(duration, display) {
          ...
          function timer() {
            ...
            if (diff <= 0) {
              alert("Time out!")
              window.location.href="analysis_test.php";
            }
          };
      timer();
    ...
    <body id="budy" onload="loaderFunc(0,1)">
      <div align="right">Time left <br><span id="time"></span></div>
        ...
        <ul class="Subjects">
          ...
          <li>
            <button style="padding-top: 2px;background-color:red; height:40px ; width:100px;" id="exit" onclick="exitFunction()"><span style="color: white;">Exit Test</span></button>
          </li>
        </ul>
    </div><br>
        ...
        <div id="Q_box">
          <div align="left">
              ...
              <button id="next" onclick="myFunction(1)">Next</button>
				...
				<div align="right" id="buttonz">
    			<div class="button-container">
       			<button onclick="myFunction(0)">Q1</button>
       			<button onclick="myFunction(1)">Q2</button>
       			<button onclick="myFunction(2)">Q3</button>
       			<button onclick="myFunction(3)">Q4</button>
       			<button onclick="myFunction(4)">Q5</button>
						<button onclick="myFunction(5)">Q6</button>
       			<button onclick="myFunction(6)">Q7</button>
       			<button onclick="myFunction(7)">Q8</button>
       			<button onclick="myFunction(8)">Q9</button>
       			<button onclick="myFunction(9)">Q10</button>
          </div>
			  </div>
      </div>
    </div>
