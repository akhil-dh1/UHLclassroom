...
<table width="100%">
    ...
    <td width="80%" valign="top">
        ...
        <table>
            ...
            <?php
            include('connect.php');
            $sql = "SELECT  fullname, user_id,login.username,login.usertype,(select image from stu_image where stu_image.user_id=stuform.user_id) as image from stuform INNER JOIN login ON stuform.user_id = login.id where login.usertype='Student'";
            $result = mysqli_query($connection, $sql)or die(mysqli_error($connection));
            if ($result->num_rows > 0) {?>
                 ...
                 <?php  while ($data = $result->fetch_assoc()){?>
                    <tr>
                       ...
                       if($data['image']){?>
                        ...
                        ?>
                        <td class="text-center col-md-4 warning" style="vertical-align:middle;"><p><a style="color: #ffffff" class="btn btn-lg btn-info btn-block" href='login.php?'>
                            <?php
                            echo $data["username"];
                            ?>
                        </a> </br></p><p>
