...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()){        echo '<span style="color:#7EC8EA;text-align:center;font-size: 18px;"><b>' . $row["Name"]."</b>"."</span>". "<br>"."<br>". $row["Url"]. "<br>"."<br>".'<span style="color:#7EC8EA;text-align:center;font-size: 15px;"> <b> Description:</b> </span>' . $row["Description"]. "<br>";
 }
...
<?php if ($_SESSION['usertype']=='Admin')
 {?>
 <div style="width: 150px; margin-left:200px; margin-top: 20px; >

<p> <a style="color: #ffffff;" class="btn btn-lg btn-info btn-block" href="delete.php?vid_id=<?php echo $row['vid_id'];?>"> Delete video </a> </p>
