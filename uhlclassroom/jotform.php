...
if (!(($_SESSION['usertype']== 'Student'|| $_SESSION['usertype']=='Vigyan Jyoti Student') && $_SESSION['verify_user']==1)){

header("location:login.php?msg= You are not authorized to visit the page.");
}?>
...
<!--jotform-->
<script type="text/javascript" src="https://form.jotform.me/jsform/82342205407448"></script>
