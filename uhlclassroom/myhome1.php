...
?>
<?php if (!($_SESSION['usertype']== 'Student' or $_SESSION['usertype']=='Vigyan Jyoti Student'&& $_SESSION['verify_user']=='1' or $_SESSION['usertype']== 'Admin')){
...
<p> <a style="color: #ffffff;" class="btn btn-lg btn-info btn-block" href="delete1.php?id=<?php echo $_SESSION['user_id'];?>"> Delete image </a> </p>
  </div>
<?php
} else {
    echo "0 results";
