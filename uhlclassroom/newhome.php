<script type="text/javascript" src="js/io.socket.js"></script><script type="text/javascript" src="js/main.js"></script><?php session_start();
...
<div style="width: 150px; margin:0 auto; ">
<?php
 if ($_SESSION["usertype"]=='Student' && $_SESSION['verify_user']=='1') {
...
?>
<?php if($_SESSION['usertype']=='Student' && $_SESSION['verify_user']=='1'){?>
...
<br>
<div align="right" style="width: 150px; margin:0px;  ">
<p> <a style="color: #ffffff;" class="btn btn-lg btn-info btn-block" href="delete2.php?user_id=<?php echo $_SESSION['user_id'];?>"> Delete image </a> </p>
  </div>
<?php
} else {
...
$sql = "SELECT * FROM `stuform` WHERE user_id='".$id."' ";
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()){        
        echo 
          "<br>"."<b>.Name: " . $row["fullname"]. "<br>" .".Father's Name: " . $row["fathername"]. "<br>"." .Email: ". $row["email"]. "<br>"." . School: " . $row["school"]. "<br>" ." . Address: " . $row["address"]. "<br>" ." . Class: " . $row["class"]. "<br>";
